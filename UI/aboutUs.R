  ...
  column(width = 8, offset = 2, 
         tags$div(class = "textCard",
                  ...
                  HTML("<p>SynergyFinder is developed by the ",
                       "<a href='https://www.helsinki.fi/en/researchgroups/network-pharmacology-for-precision-medicine'>Network Pharmacology for Precision Medicine</a>",
                  ...
                  fluidRow(
                    ...
                    column(width = 6, 
                           tags$div(#class = "textCard",
                             tags$h3("Previous members & collaborators"),
                             HTML("<p class='textCard left-deep-orange'>",
                                  "<b>Tero Aittokallio</b>", 
                                  "<br/>",
                                  "Group Leader",
                                  "<br/>",
                                  "Professor",
