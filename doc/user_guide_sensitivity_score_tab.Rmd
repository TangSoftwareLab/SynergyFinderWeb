...
3. Plotting area for Synergy-Sensitivity plot(S-S plot).All of the plots can be customized and downloaded. Please check section 2.2 below for more details.
